...
#	0-repo-edit.sh
#=======================================================================
#Author: Yannick Abouem (AntaresMKII)
#Date: 8/24/2020
#Description:
...
echo "Changing default mirror to " $ans

sudo mkdir -p /etc/xbps.d
sudo cp /usr/share/xbps.d/*-repository-*.conf /etc/xbps.d/

MIRROR="s|https://alpha.de.repo.voidlinux.org/current|${mirrors[$ans]}|g"

sudo sed -i $MIRROR /etc/xbps.d/*-repository-*.conf


#=======================================================================
#	Sync repository and update system
#=======================================================================

echo "Sync repository and updating system"
echo "=============================================="
